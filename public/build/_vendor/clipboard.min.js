...
!(function(t) {
    ...
    (e =
      typeof window != "undefined"
        ...
        : typeof global != "undefined"
          ? global
          : typeof self != "undefined" ? self : this), (e.Clipboard = t());
  }
})(function() {
  var t, e, n;
  return (function t(e, n, o) {
    ...
    for (var r = typeof require == "function" && require, a = 0; a < o.length; a++) {
      i(o[a]);
    }
    return i;
  })(
        ...
        function(t, e, n) {
          function o(t) {
            ...
            if (t.nodeName === "SELECT") {
              ...
              n || t.setAttribute("readonly", ""), t.select(), t.setSelectionRange(
                0,
                t.value.length
                ...
                return a(t, [
                  {
                    ...
                    value: function t() {
                      ...
                      (this.action = e.action), (this.container = e.container), (this.emitter =
                        e.emitter), (this.target = e.target), (this.text = e.text), (this.trigger =
                        e.trigger), (this.selectedText = "");
                    }
                  },
                  {
                    key: "initSelection",
                  ...
                  },
                  {
                    ...
                    value: function t() {
                      ...
                      this.removeFake(), (this.fakeHandlerCallback = function() {
                        ...
                        "textarea"
                      )), (this.fakeElem.style.fontSize = "12pt"), (this.fakeElem.style.border =
                        "0"), (this.fakeElem.style.padding = "0"), (this.fakeElem.style.margin =
                        "0"), (this.fakeElem.style.position = "absolute"), (this.fakeElem.style[
                        n ? "right" : "left"
                      ] =
                        "-9999px");
                      ...
                      (this.fakeElem.style.top = o + "px"), this.fakeElem.setAttribute(
                        "readonly",
                        ""
                      ), (this.fakeElem.value = this.text), this.container.appendChild(
                        this.fakeElem
                  ...
                  },
                  {
                    ...
                    set: function t() {
                      ...
                      if (((this._action = e), this._action !== "copy" && this._action !== "cut")) {
                      ...
                      value: function t() {
                        ...
                        (this.action =
                          typeof e.action == "function"
                            ? e.action
                            : this.defaultAction), (this.target =
                          typeof e.target == "function"
                            ? e.target
                            : this.defaultTarget), (this.text =
                          typeof e.text == "function"
                            ? e.text
                            : this.defaultText), (this.container =
                          d(e.container) === "object" ? e.container : document.body);
                      }
                    },
                    {
                      key: "listenClick",
                  ...
                  [
                    {
                      ...
                      value: function t() {
                        var e =
                          ...
                          o = Boolean(document.queryCommandSupported);
                        return n.forEach(function(t) {
                          o = o && Boolean(document.queryCommandSupported(t));
                        }), o;
                      }
                    }
                  ]
