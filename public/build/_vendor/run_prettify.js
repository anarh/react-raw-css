...
*/
  (function() {
    function ba(g) {
      ...
      function z(k) {
        if (k.type != "readystatechange" || A.readyState == "complete") {
          (k.type == "load" ? t : A)[B](p + k.type, z, !1), !q &&
            (q = !0) &&
            g.call(t, k.type || k);
        }
      }
    ...
    B.replace(/[?&]([^&=]+)=([^&]+)/g, function(g, k, z) {
      ...
      k == "autorun"
        ? (V = !/^[0fn]/i.test(z))
        : k == "lang" ? H.push(z) : k == "skin" ? Q.push(z) : k == "callback" && N.push(z);
    });
    q = 0;
      ...
      (function() {
        function k(a) {
          function d(e) {
            ...
            return (b = W[a])
              ...
              : a >= "0" && a <= "7"
                ...
                : a === "u" || a === "x" ? parseInt(e.substring(2), 16) : e.charCodeAt(1);
          }
          function f(e) {
            if (e < 32) {
            ...
            for (var a = a ? 1 : 0, h = b.length; a < h; ++a) {
              ...
              if (/\\[bdsw]/i.test(l)) {
                ...
                n < 65 ||
                  l > 122 ||
                  (
                    n < 65 || l > 90 || e.push([Math.max(65, l) | 32, Math.min(n, 90) | 32]),
                    n < 97 || l > 122 || e.push([Math.max(97, l) & -33, Math.min(n, 122) & -33])
                  );
              }
            }
            e.sort(function(e, a) {
          ...
          function g(e) {
            ...
            if (e.ignoreCase && I) {
              for (h = 0; h < c; ++h) {
                (n = a[h]), (e = n.charAt(0)), n.length >= 2 && e === "["
                  ? (a[h] = b(n))
                  : e !== "\\" &&
          ...
          for (
            ...
            r = a[J];
            if (r.global || r.multiline) {
              throw Error(String(r));
            }
            u.push("(?:" + g(r) + ")");
          }
        ...
        function A(a) {
          for (var d = void 0, f = a.firstChild; f; f = f.nextSibling) {
            var b = f.nodeType,
              d = b === 1 ? (d ? a : f) : b === 3 ? (T.test(f.nodeValue) ? a : d) : d;
          }
          return d === a ? void 0 : d;
        }
        function C(a, d) {
        ...
        function x(a) {
          ...
          b = String(a.keywords).replace(/^ | $/g, "");
          b.length &&
            f.push(["kwd", new RegExp("^(?:" + b.replace(/[\s,]+/g, "|") + ")\\b"), null]);
          d.push(["pln", /^\s+/, null, " \r\n\t\u00a0"]);
          b = "^.[^\\s\\w.$@'\"`/\\\\]*";
          a.regexLiterals && (b += "(?!s*/)");
          f.push(
        ...
        function B(a, d, f) {
          ...
          function g(a) {
            ...
            a = b(a.nextSibling, 0);
            for (var d; (d = a.parentNode) && d.nodeType === 1; ) {
              a = d;
            }
            c.push(a);
          }
          ...
          for (var r = 0, u = c.length; r < u; ++r) {
            (p = c[r]), (p.className = "L" + (r + d) % 10), p.firstChild ||
              p.appendChild(m.createTextNode("\u00a0")), t.appendChild(p);
          }
          a.appendChild(t);
        }
        function p(a, d) {
              ...
              function f() {
                for (
                  ...
                  for (var d = p[r], k = h, q = d; (q = q.previousSibling); ) {
                    var m = q.nodeType,
                      v = (m === 7 || m === 8) && q.nodeValue;
                    if (v ? !/^\??prettify\b/.test(v) : m !== 3 || /\S/.test(q.nodeValue)) {
                      break;
                    }
                    if (v) {
                      k = {};
